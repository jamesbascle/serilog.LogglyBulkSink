...
namespace Serilog.LogglyBulkSink.Tests
{
    ...
    public class SerilogLogglyBulkSinkTests
    {
        ...
        public void PackageContentsTest()
        {
            ...
            Assert.IsNotNull(noDiagContent);
            ...
            Assert.AreEqual(resultNoDiag.Split('\n').Length,3);
        }
        ...
        public void TestRender()
        {
            ...
            Assert.AreEqual(json["test1"].Value as string, "answer1");
            bool hasZero = (json["0"] == null);
            Assert.True(hasZero);
            Assert.AreEqual(json["key"].Value as string,"value");
        }
        ...
        public void IncludeDiagnostics_WhenDisbled_DoesNotIncludeDiagnosticsEvent()
        {
            ...
            Assert.IsFalse(packageString.Contains("LogglyDiagnostics"));
        }
